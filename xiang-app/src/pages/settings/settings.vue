  ...
  <div class="profile-page">
    ...
    <section class="action-card">
      <div class="action-grid">
        <button type="button" class="action-button" @click="router.push('/settings/voice')">
          语音设置
        </button>
        <button type="button" class="action-button" @click="router.push('/settings/global-prompt')">
          个性调校
        </button>
      </div>

      <button type="button" class="edit-button" @click="router.push('/settings/user-info')">
        编辑个人资料
      </button>
    </section>
    ...
    <section class="feature-grid">
      <button type="button" class="feature-card" @click="router.push('/settings/coins')">
        <span class="feature-icon-shell">
          <img src="/src/static/images/profile-coin.svg" alt="我的卜币" class="feature-icon feature-icon-coin" />
        </span>
      ...
      <button type="button" class="feature-card" @click="router.push('/settings/levels')">
        <span class="feature-icon-shell">
          <img src="/src/static/images/profile-level.svg" alt="我的等级" class="feature-icon" />
        </span>
        <div class="feature-copy">
          <strong>我的等级</strong>
...
.hero-card {
  ...
  background:
    radial-gradient(circle at 80% 20%, rgba(56, 189, 248, 0.10) 0%, transparent 42%),
    linear-gradient(145deg, rgba(36, 16, 52, 0.70), rgba(14, 8, 28, 0.94));
}
...
.feature-card {
  ...
  &:nth-child(2) {
    ...
    background:
      radial-gradient(circle at 80% 20%, rgba(52, 211, 153, 0.10) 0%, transparent 50%),
      linear-gradient(145deg, rgba(255, 255, 255, 0.12), rgba(255, 255, 255, 0.06));
  }
