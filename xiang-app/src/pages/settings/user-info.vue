...
import { isRemoteAssetURL, uploadAsset } from '@/services/files'
...
async function saveUserInfo() {
  ...
  try {
    ...
    if (avatar && !isRemoteAssetURL(avatar)) {
      ...
      avatar = uploaded.url
      formData.value.avatar = uploaded.url
    }
...
.user-info-page {
  ...
  background:
    ...
    linear-gradient(180deg, rgb(8, 9, 10) 0%, rgb(12, 13, 15) 100%);
