...
| [交互式设计.md](./交互式设计.md) | 交互事件规范、图片/朋友圈/游戏/H5 设计规范、实现指南 |
| [剧情.md](./剧情.md) | 星的 60 天主线剧情全文（10 卷） |
| [星.md](./星.md) | 星的角色设定提示词（性格、说话风格、互动原则） |
